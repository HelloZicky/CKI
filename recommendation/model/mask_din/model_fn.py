...
@model("mask_din", MetaType.ModelBuilder)
class DeepInterestNetwork(nn.Module):
    def __init__(self, model_conf, base_param):
        ...
        self._mask_classifier_param_list = common.HyperNetwork_FC_mask(
            model_conf.id_dimension,
            model_conf.classifier + [1],
            ([torch.nn.Tanh] * len(model_conf.classifier)) + [None],
    ...
    def forward(self, features, duet_param, fig1=False):
        # Encode target item
        # B * D
        # print("-" * 50)
        # print(features)
        ...
        return self._mask_classifier_param_list(classifier_input, hist_embed, duet_param,
