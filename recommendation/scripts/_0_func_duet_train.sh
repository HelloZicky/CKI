...
######################################################################
LEARNING_RATE=0.001
CHECKPOINT_PATH=../checkpoint/${dataset}_${model}/duet
######################################################################
...
USER_DEFINED_ARGS="--model=meta_${model} --num_loading_workers=1 --arch_config=${ARCH_CONFIG_CONTENT} --learning_rate=${LEARNING_RATE} \
...
python ../main/multi_metric_meta_train.py \
--dataset=${data} \
${USER_DEFINED_ARGS}
